...
export const MenuLayout = ({ children, ...routeProps }) => {
  ...
  if (!project.hasOwnProperty("created_by"))
    projectOwnerId = localStorage.getItem("projectOwnerId");
  if (!project.hasOwnProperty("id"))
    projectId = localStorage.getItem("projectId");
  if (projectOwnerId == undefined)
    localStorage.setItem("projectOwnerId", project.created_by.id);
  ...
  return (
    <SidebarMenu
      menuItems={getVisibleComponents(userRole)}
